...
export default function ResidentialCleaningPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12">
      <h1 className="font-heading text-3xl sm:text-4xl font-semibold text-brand-900">Residential Cleaning</h1>
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-2 space-y-4 text-zinc-700">
          ...
          <div>
            <h2 className="font-heading text-xl text-brand-900">Options / Add-ons</h2>
            <ul className="mt-2 list-disc pl-5 space-y-1">
