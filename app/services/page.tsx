...
export const metadata: Metadata = {
  ...
  description: 'Residential, Commercial/Office, Deep Cleaning, Move-In/Move-Out, Window Cleaning.',
};
  ...
  return (
    <div>
      <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12">
        <h1 className="font-heading text-3xl sm:text-4xl font-semibold text-brand-900">Services</h1>
