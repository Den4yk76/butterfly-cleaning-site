...
export const metadata: Metadata = {
  title: `Move-In/Move-Out Cleaning — ${site.name}`,
  description:
    'Empty-space detailing: cabinets/drawers inside, baseboards, closets, appliances inside/out.',
};

export default function MoveInMoveOutCleaningPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12">
      <h1 className="font-heading text-3xl sm:text-4xl font-semibold text-brand-900">Move-In / Move-Out Cleaning</h1>
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-2 space-y-4 text-zinc-700">
          <p>Perfect for handing over or moving into a fresh, clean space.</p>
          <div>
            <h2 className="font-heading text-xl text-brand-900">What’s included</h2>
            <ul className="mt-2 list-disc pl-5 space-y-1">
              <li>Cabinets and drawers inside</li>
              <li>Baseboards and closets</li>
              <li>Appliances inside/out</li>
              <li>Detailing of empty rooms</li>
            </ul>
          </div>
