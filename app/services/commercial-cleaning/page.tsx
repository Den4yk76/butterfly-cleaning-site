...
export default function CommercialCleaningPage() {
  return (
    <div className="mx-auto max-w-6xl px-4 sm:px-6 py-12">
      <h1 className="font-heading text-3xl sm:text-4xl font-semibold text-brand-900">Commercial / Office Cleaning</h1>
      <div className="mt-6 grid grid-cols-1 md:grid-cols-3 gap-8">
        <div className="md:col-span-2 space-y-4 text-zinc-700">
          <p>Keep your workspace fresh and welcoming with reliable, consistent care.</p>
          <div>
          ...
          <div>
            ...
            <p className="mt-2">During or after hours; custom schedules available.</p>
          </div>
